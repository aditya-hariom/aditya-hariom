...
**Generative AI Developer · Full-Stack Explorer**
...
I'm a Computer Science undergraduate focused on the intersection of **Generative AI** and **Full-Stack Web Development**. I build end-to-end intelligent applications — connecting LLMs, RAG pipelines, and vector databases with modern, responsive web interfaces.

- 🎓 **Education**: B.Tech CSE (Final Year)
- 🤖 **Core Focus**: Generative AI, RAG pipelines & Vector Databases (ChromaDB)
- 💻 **Full-Stack Stack**: React, Node.js, Express, MongoDB & Python / FastAPI
- 🚀 **What I Do**: Bridging the gap between AI models and real-world web applications
- 🎯 **Target Roles**: GenAI Developer / AI-Focused Software Engineer
- 📫 **Open to**: Internships, entry-level opportunities, and open-source contributions
